...
- **声の正典（2026-07-06・Fable最終セッション成果物）**: `voice_bible_v0.md`（文体バイブル＝金型。ドラマ主軸・自嘲/デッドパンの一滴1/6・感情は固有の物へ転写・○×チェックリスト＋較正ギャラリー。writing_craft §2を上書き） / `voice_corpus_v0.md`（技法タグ付きgold seed＝各スロット◯×対の見本集＋量産への申し送り。量産はこの2枚をfew-shotしてから）
